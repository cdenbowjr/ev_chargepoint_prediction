...
class DataDictionary:
    def __init__(self, data, target, description, central_london, greater_london):
        self.data = data
        self.target = target
        self.description = description
        self.central_london = central_london
        self.greater_london = greater_london
...
variable_description = {'msoa11cd': 'Middle Layer Super Output Areas (MSOA) code at December 2011',
                        ...
                        'income_score': 'measures the proportion of the population experiencing deprivation relating '
                                        'to low '
                                        'income. The definition of low income used includes both those people that are '
                                        'out-of-work, and those that are in work but who have low earning',
                        'employment_score': 'measures the proportion of the working-age population in an area '
                                            'involuntarily '
                                            'excluded from the labour market. This includes people who would like to '
                                            'work but '
                                            'are unable to do so due to unemployment, sickness or disability, '
                                            'or caring responsibilities',
                        'education_score': 'measures the lack of attainment and skills in the local population',
                        'health_score': 'measures the risk of premature death and the impairment of quality of life '
                                        'through '
                                        'poor physical or mental health. The domain measures morbidity, disability and '
                                        'premature mortality but not aspects of behaviour or environment that may be '
                        ...
                        'housebar_score': 'measures the physical and financial accessibility of housing and local '
                                          'services',
                        'livenv_score': 'measures the quality of the local environment',
                        'idaci_score': 'measures the proportion of the population experiencing deprivation relating '
                                       'to low '
                                       'income which affects children',
                        'idaopi_score': 'measures the proportion of the population experiencing deprivation relating '
                                        'to low '
                                        'income which affects old people',
                        'chanyp_score': 'measures the lack of attainment and skills in the local population relating '
                                        'to children and young people.',
                        'adultskills_score': 'measures the lack of attainment and skills in the local population '
                                             'relating to adult skills.',
                        'geo_bar_score': 'measures the physical and financial accessibility of housing and local '
                                         'services based on physical proximity of local services (geographical '
                                         'barriers)',
                        'widerbar_score': 'measures the physical and financial accessibility of housing and local '
                                          'services based on access to housing such as affordability (wider barriers)',
                        'indoor_score': 'measures the quality of the local environment based on quality of housing ('
                                        'indoors)',
                        'outdoor_score': 'measures the quality of the local environment based on  air quality and '
                                         'road traffic accidents (outdoors)',
                        ...
                        'total_inc': 'Total annual household income:csum of the gross income of every member of the '
                                     'household plus any income from benefits such as Working Families Tax Credit',
                        'total_netinc': 'Net annual household income: sum of the net income of every member of the '
                                        'household',
                        'total_netb4hsing': 'Net annual household income before housing costs (equivalised): rent, '
                                            'water rates, mortgage interest, structural insurance and other service '
                                            'charges',
                        'total_netafterhsing': 'Net annual household income after housing costs (equivalised): rent, '
                                               'water rates, mortgage interest, structural insurance and other '
                                               'service charges',
                        ...
                        'walk_to_empbus': 'average weekday number of journeys done by walking to employers business ('
                                          'home-based)',
                        'walk_empbus': 'average weekday number of journeys done by walking to/from employers business',
                        'walk_from_empbus': 'average weekday number of journeys done by walking from employers '
                                            'business (home-based)',
                        ...
                        'walk_from_school': 'average weekday number of journeys done by walking from school ('
                                            'home-based)',
                        'walk_shopping': 'average weekday number of journeys done by walking to/from shopping',
                        'walk_to_shopping': 'average weekday number of journeys done by walking to shopping ('
                                            'home-based)',
                        'walk_from_shopping': 'average weekday number of journeys done by walking from shopping ('
                                              'home-based)',
                        'walk_personbus': 'average weekday number of journeys done by walking to/from personal business',
                        'walk_to_personbus': 'average weekday number of journeys done by walking to personal business '
                                             '(home-based)',
                        'walk_from_personbus': 'average weekday number of journeys done by walking from personal '
                                               'business (home-based)',
                        'walk_social': 'average weekday number of journeys done by walking to/from recreation',
                        'walk_to_social': 'average weekday number of journeys done by walking to recreation ('
                                          'home-based)',
                        'walk_from_social': 'average weekday number of journeys done by walking from recreation ('
                                            'home-based)',
                        'walk_friends': 'average weekday number of journeys done by walking to/from visit friends',
                        'walk_to_friends': 'average weekday number of journeys done by walking to visit friends ('
                                           'home-based)',
                        'walk_from_friends': 'average weekday number of journeys done by walking from visit friends ('
                                             'home-based)',
                        ...
                        'walk_from_holiday': 'average weekday number of journeys done by walking from holidays ('
                                             'home-based)',
                        'walk_to_work_nhb': 'average weekday number of journeys done by walking to work (non '
                                            'home-based)',
                        'walk_from_work_nhb': 'average weekday number of journeys done by walking from work (non '
                                              'home-based)',
                        'walk_to_empbus_nhb': 'average weekday number of journeys done by walking to employers '
                                              'business (non home-based)',
                        'walk_from_empbus_nhb': 'average weekday number of journeys done by walking from employers '
                                                'business (non home-based)',
                        'walk_to_school_nhb': 'average weekday number of journeys done by walking to school (non '
                                              'home-based)',
...
ev_britain = DataDictionary(data=ev_charge_feat,
                            target=ev_charge_target,
                            description=variable_description,
                            central_london=central_london_boroughs,
                            greater_london=greater_london_boroughs)
