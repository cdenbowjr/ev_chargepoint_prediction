...
elec_d.columns = ['lad13nm', 'lad13cd', 'msoa11nm', 'msoa11cd', 'elec_d_con', 'd_meters', 'elec_d_con_mean',
                  'elec_d_con_mdn']
elec_nd.columns = ['lad13nm', 'lad13cd', 'msoa11nm', 'msoa11cd', 'elec_nd_con', 'nd_meters', 'elec_nd_con_mean',
                   'elec_nd_con_mdn']

elec_d = elec_d[
    ['msoa11nm', 'msoa11cd', 'lad13cd', 'lad13nm', 'elec_d_con', 'd_meters', 'elec_d_con_mean', 'elec_d_con_mdn']]
elec_nd = elec_nd[
    ['msoa11nm', 'msoa11cd', 'lad13cd', 'lad13nm', 'elec_nd_con', 'nd_meters', 'elec_nd_con_mean', 'elec_nd_con_mdn']]
...
elec_con.loc[:, 'elec_d_con':'elec_nd_con_mdn'] = elec_con.loc[:, 'elec_d_con':'elec_nd_con_mdn'].apply(
    lambda x: abs(x))
