...
for folder in list_of_folders:
    ...
    for travel, car_own in zip(travel_data, car_own_data):
        ...
        for num, traveltype in enumerate(list_of_excel_tabs.items()):
            ...
            travel_headers = ["msoa11cd", "msoa11nm", "to_work", "from_work", "to_empbus", "from_empbus", "to_school",
                              "from_school",
                              "to_shopping", "from_shopping", "to_personbus", "from_personbus", "to_social",
                              "from_social", "to_friends",
                              "from_friends", "to_holiday", "from_holiday", "to_work_nhb", "from_work_nhb",
                              "to_empbus_nhb",
                              "from_empbus_nhb", "to_school_nhb", "from_school_nhb", "to_shopping_nhb",
                              "from_shopping_nhb", "to_personbus_nhb", "from_personbus_nhb",
